...
import com.imsdk.imdeveloper.ui.fragment.WorkFragment;
...
public class MainActivity extends FragmentActivity {
	...
	private int[] mItemImage = { R.drawable.tab_nearby, R.drawable.tab_news,
			R.drawable.tab_contact, R.drawable.tab_work,
			R.drawable.tab_me };
	private int[] mItemCheckedImage = { R.drawable.tab_nearby_, R.drawable.tab_news_,
			R.drawable.tab_contact_,
			R.drawable.tab_work_,
			R.drawable.tab_me_ };
	private String[] mItemText = { "动态", "消息", "联系人", "工作", "我的" };
	...
	public void initContentView() {
		...
		mBody.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageScrolled(int arg0, float arg1, int arg2) {
				if ((arg0 == 2 && arg2 < 1) || (arg0 == 3 && arg2 < 1)) {
		...
		mFragmentsList.add(workFragment);
		...
		IMMyselfRelations.setOnRelationsEventListener(new OnRelationsEventListener() {
			...
			public void onReceiveRejectToFriendRequest(String reason,
				...
				if (isBackground(MainActivity.this)) {
					showNotify(notifyId++, fromCustomUserID + "拒绝了你的好友请求！", "移动信息管理平台",
							MainActivity.this);
				}
			...
			public void onReceiveFriendRequest(String text,
				...
				if (isBackground(MainActivity.this)) {
					showIntentActivityNotify(notifyId++, "附加消息：" + text, "提示：收到 "
